package modules.sddzGame.sddzInerGame.view
{
	...
	import modules.sddzGame.sddzInerGame.view.playerInfoPart.UserInfoPage;
	...
	import ui.sddzGame.GameTableUI;
	import ui.sddzGame.PockerPageUI;
	
	
	public class SddzGameView extends AbstractLayer
	{
		protected var _sddzPage:SddzPage;
		...
		public function get sddzPage():SddzPage
		{
			return _sddzPage;
		}
		...
		protected function onAddUI():void
		{
			...
			if(_sddzPage == null)
			{
				_sddzPage = new SddzPage(new PockerPageUI());
				_gui.pokerContainer.addChild(_sddzPage.skin);
			}
		...
		private function initPopChat(chairNum:int=3):void
		{
			...
			switch(chairNum)
			{
				...
				case 3:popChatArr.push(_gui.popChat0,_gui.popChat1,_gui.popChat2);break;
		...
		private function showPopChat(uid:*,worlds:String):void
		{
			...
			{
				popChatArr[dir].x = 218 + (392 - popChatArr[dir].tf.textField.textWidth);
			}
		...
		public function Voice():void
		{
			...
			Browser.window.wx.onVoicePlayEnd({
				success: function (res):void {
					...
					Laya.timer.clear(SDdzGameModule.instance.gameContext.view,recoverSoundVolume);
