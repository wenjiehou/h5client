package modules.sddzGame.sddzInerGame.view.pockerPart.card
{
	...
	public class BasePocker
	{
		...
		/**三个带一*/
		public static const PAIXING_SANYI:int = 4;
		
		/**三个带2*/
		public static const PAIXING_SANER:int = 5;
		
		/**连对*/
		public static const PAIXING_LIANDUI:int = 6;
		
		/**顺子*/
		public static const PAIXING_SHUNZI:int = 7;
		
		/**飞机*/
		public static const PAIXING_FEIJI:int = 8;
		
		/**四个带2*/
		public static const PAIXING_SIDAIER:int = 9;
		
		/**炸弹*/
		public static const PAIXING_ZHADAN:int = 10;
		
		/**对王*/
		public static const PAIXING_DUIWANG:int = 11;
