package modules.sddzGame.sddzInerGame.model
{
	...
	/**三人斗地主数据*/
	public class SddzModel extends AbstractLayer
	{
		/**房主*/
		...
		public var sddzMsgs:SddzMsgs = new SddzMsgs();
		...
		{
			if(isGameStart || sddzMsgs.ACK_RoomInfo.RoundCount > 0)
			{
				return true;
			}
			return false;
...
//		/**更新所有牌(游戏开始后的第一次发牌）第一次发牌没有明牌，不用考虑  allCards [1,2,2,3,...]*/
//		public function updateAllCards(allCards:Array):void
//		{
//			trace("selfCards ::" + allCards);
//			
//			var i:int;
//			var len:int = handleCards.length;
//			
//			for(i=0;i<len;i++)
//			{
//				if(i == selfChairPos)
...
//					for(j=0;j<leng;j++)
//					{
//						handleCards[i].push(allCards[j]);
//					}
//				}
//				else
//				{
//					var k:int,n:int = allCards.length;
//					for(k=0;k<n;k++)
//					{
//						handleCards[i].push(0);
//					}
//				}
//				handleCards[i].sort(PaixingLogic.compCardsFun);
//			}
//		}
