package modules.nnGame.inerGame.view.playerInfoPart
{
	...
	public class GiftEff
	{
		...
		{
//			var jinbiAni:Animation = new Animation();
//			jinbiAni.loadAtlas("res/animations/goldflay/jinbeikuang.atlas");
//			jinbiAni.play();
//			
//			jinbiAni.x = 200;
//			jinbiAni.y = 200;
//			
//			UIManager.instance.popLayer.addChild(jinbiAni);
			//
...
//		}
		...
		protected var offsetX:int = -60;
		protected var offsetY:int = -60;
		...
		protected function onLoaded(mc:MovieClip,fromDir:int,toDir:int,sound:String,sounddelay:int):void
		{
			...
			mc.x = BasePlayerInfoItem.DIRPOS_REFERENCE[fromDir].x+offsetX;
			mc.y = BasePlayerInfoItem.DIRPOS_REFERENCE[fromDir].y+offsetY;
...
//			}
			...
			tX= BasePlayerInfoItem.DIRPOS_REFERENCE[toDir].x+offsetX;
			tY= BasePlayerInfoItem.DIRPOS_REFERENCE[toDir].y+offsetY;
//			switch(toDir)
//			{
//				case 0:
//					tX = -57;
