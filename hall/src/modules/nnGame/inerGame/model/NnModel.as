package modules.nnGame.inerGame.model
{
	...
	/**四人斗地主数据*/
	public class NnModel extends AbstractLayer
	{
		
		public var isReConn:Boolean = false;
		...
		public var srddzMsgs:NnMsgs = new NnMsgs();
		...
		public var canStartInto:Boolean = true;
		...
		/**玩家下注*/
		public var xiazhuVec:Vector.<int> = new Vector.<int>();
		...
		public function resetCard():void
		{
			...
			for(i=0;i<len;i++)
			{
				...
				var player:Object = playerByPos(i) ;
				
				if(player!= null)
				{
					player.haveJiao = false;
					playerByPos(i).haveXiazhu = false;
					playerByPos(i) .jiaofen = 0;
				}
